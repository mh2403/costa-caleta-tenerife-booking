  ...
  return (
    <section className="relative overflow-hidden bg-gradient-sunset py-14 text-primary-foreground md:py-20">
      ...
      <div className="container mx-auto px-4">
        <div className="relative mx-auto max-w-3xl rounded-[1.9rem] border border-primary-foreground/28 bg-foreground/22 px-5 py-7 text-center backdrop-blur-xl shadow-[0_24px_62px_-26px_rgba(0,0,0,0.6)] md:px-8 md:py-9">
